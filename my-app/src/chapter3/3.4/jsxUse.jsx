...
function JsxUse(props) {
  ...
  // 2. 꼭 감싸져야만 하는 태그
  // 두 개 이상의 태그는 무조건 하나의 태그로 감싸주어야 함
  // const element = (
  ...
  //   이렇게 불필요하게 감싸는게 별로 좋지 않을 때도 있음
  //   HTML 중첩 구조가 복잡해지며 그에 따른 스타일 설정을 할 때에도 복잡해짐
  ...
  // 4. style과 className
  // 인라인 스타일은 객체 형태로 작성하는데 background-color처럼 -로 구분되어있는 이름은 camelCase 형태로 네이밍
