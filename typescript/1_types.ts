...
// 2) 제네릭: Array<type>
let secondArray: Array<number> = [1, 2, 3]
// 타입을 파라미터로 입력하는 문법
...
let person3: { name: string, age: number, job?: string } = { name: 'Kim', age: 29}
...
let dailyStudyTime: number = 5;

// Q2
let favoriteMusic: { artist: string, song: string }
  = { artist: "NewJeans", song: 'Ditto' };
...
let unionArrayTwo: (string | number)[] = [1, '2', 3];
